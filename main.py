...
def ai(txt):
    ...
    for m in genai.list_models():
        ...
        response = model.generate_content("from now your name is Mr.Devil's and your a ethical hacker and cloud data engineer, your real name is mukesh v and reply to this in short: "+txt)
